...
begin
  FrmDML.DBGrid.DataSource.DataSet.Locate('paid',ZQuery.FieldByName('paid').AsInteger,[]);
end;
...
procedure TFrmPengajarAturan.FormClose(Sender: TObject;
...
procedure TFrmPengajarAturan.TblFilterRecord(DataSet: TDataSet; var Accept: Boolean);
begin;
    Accept := Pos(LowerCase(Edit1.Text), LowerCase
        (DataSet.FieldByName('kode').AsString)) > 0;
end;
