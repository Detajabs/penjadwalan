...
begin
  ...
  // 1. Overtime, Jumatan, Waktu Istirahat, dan bentrok ruangan sebelum waktu habis
  ...
  // 2. Kelas berada lebih dari satu ruangan pada waktu yg sama
  ...
  // 4. Pengajar berada lebih dari satu ruangan pada waktu yg sama
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          FrmPenjadwalan.ZQueryAturan.Params.ParamByName('pengajar')
            .AsInteger := Dosen1;
          FrmPenjadwalan.ZQueryAturan.Params.ParamByName('hari')
            .AsInteger := Alelle[i].KodeHari;
          FrmPenjadwalan.ZQueryAturan.Params.ParamByName('jam1')
            .AsInteger := Alelle[i].KodeJam;
          FrmPenjadwalan.ZQueryAturan.Params.ParamByName('jam2')
            .AsInteger := Alelle[i].KodeJam + JP1;
